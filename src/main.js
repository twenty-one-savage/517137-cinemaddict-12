...
const createAppMainNavigationTemplate = () => {
  return (
    `
...
const createAppBtnShowMoreTemplate = () => {
  return (
    `
...
const createAppFilmPopupTemplate = () => {
  return (
    `
